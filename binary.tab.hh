...
#line 60 "binary.tab.hh" // lalr1.cc:372
...
namespace yy {
#line 136 "binary.tab.hh" // lalr1.cc:372
  ...
  basic_symbol (typename Base::kind_type t, const EFunction* v);

  basic_symbol (typename Base::kind_type t, const Expression* v);

  basic_symbol (typename Base::kind_type t, const Sequence* v);
    ...
    , value ()
  {
      switch (other.type_get ())
    {
      case 75: // functioncall
        value.copy< EFunction* > (other.value);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const EFunction* v)
    : Base (t)
    , value (v)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const Sequence* v)
    : Base (t)
    , value (v)
  {}

  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const Statement* v)
    : Base (t)
    , value (v)
  {}
  ...
  parser::basic_symbol<Base>::~basic_symbol ()
  {
   ...
   default:
    ...
    {
      case 75: // functioncall
        value.template destroy< EFunction* > ();
        break;
...
#line 1887 "binary.tab.hh" // lalr1.cc:372
